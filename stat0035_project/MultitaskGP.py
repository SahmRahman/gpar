...
for input_col_names in (['Wind.speed.me'],
                        ['Wind.speed.me', "Wind.dir.sin.me", 'Wind.dir.cos.me'],
                        ['Wind.speed.me', "Wind.dir.sin.me", 'Wind.dir.cos.me', 'Nacelle.ambient.temp.me']):
    ...
    for turbines in all_combinations():
        ...
        for j in range(len(turbines)):
            ...
            ph.append_to_pickle(
                file_path="/Users/sahmrahman/Desktop/GitHub/stat0035_project/MTGP Modelling History.pkl",
                new_row=new_row)
