...
#     current_turbine_data = train_data[train_data['turbine'] == turbine]
#     print(f"Turbine {turbine} data")
#     print(current_turbine_data['Wind.speed.me'])
#     print('\n')
#     print(current_turbine_data['Power.me'])